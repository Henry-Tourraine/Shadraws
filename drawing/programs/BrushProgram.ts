...
import { Program } from "./programs";
 ...
 export class BrushProgram extends Program{
    ...
    constructor(gl: WebGL2RenderingContext, vert: string, frag: string, verbose:Boolean=false){
        ...
        sketch(e: TouchEvent){
            ...
            //console.log("draw ", fill);
                ...
                this.useProgram();
                this.bindVAO();
                this.setSampler(l.textures.mains.textures[l.textures.mains.active]!, "uSampler");
           
    
                console.log("fill render target -> ", l.textures.mains.active  == 0 ? 1 : 0);
            
                
                this.setRenderTarget(l.textures.mains.textures[l.textures.mains.active  == 0 ? 1 : 0]!);
                
                this.setUColor();
                this.setUBlur();
                this.setUSize(this.size);
